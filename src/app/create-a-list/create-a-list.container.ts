...
export class CreateAListContainer implements OnInit, OnDestroy {
  ...
  onListPublished(publishStatus: PublishStatus) {
    this.publishCourtListMessage = `${getPublishCourtListLabel(publishStatus.publishCourtListType).toUpperCase()} hearing list published: ${this.selectedOptions.courtCentre}, All courtrooms, ${publishStatus.displayDate}`;
  }
